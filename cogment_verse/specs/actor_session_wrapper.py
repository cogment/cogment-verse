...
class ActorSessionWrapper:
    ...
    def mixin(cls, actor_session: ActorSession, model_registry: ModelRegistry):
        ...
        actor_session.action_space = actor_session.environment_specs.get_action_space(seed=actor_session.config.seed)
        actor_session.observation_space = actor_session.environment_specs.get_observation_space()
