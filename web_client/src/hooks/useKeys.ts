...
export const useKeys = (event: Event<data_pb.cogment_verse.Observation>, sendAction: SendAction<data_pb.cogment_verse.AgentAction>, trialJoined: boolean, actorConfig: any) => {
