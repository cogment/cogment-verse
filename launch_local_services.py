...
from cogment_verse.constants import DATASTORE_DIR, DEFAULT_WORK_DIR, MODEL_REGISTRY_DIR
...
def main(cfg):
    ...
    datastore_dir = os.path.join(work_dir, DATASTORE_DIR)
    model_registry_dir = os.path.join(work_dir, MODEL_REGISTRY_DIR)
